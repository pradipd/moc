...
type Subnet struct {
	Name                 string                    `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Idxxx                string                    `protobuf:"bytes,2,opt,name=idxxx,proto3" json:"idxxx,omitempty"`
	...
	Reserverdips         []string                  `protobuf:"bytes,7,rep,name=reserverdips,proto3" json:"reserverdips,omitempty"`
	Vippoolstartip       string                    `protobuf:"bytes,8,opt,name=vippoolstartip,proto3" json:"vippoolstartip,omitempty"`
	Vippoolendip         string                    `protobuf:"bytes,9,opt,name=vippoolendip,proto3" json:"vippoolendip,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (m *Subnet) GetReserverdips() []string {
	if m != nil {
		return m.Reserverdips
	}
	return nil
}

func (m *Subnet) GetVippoolstartip() string {
	if m != nil {
		return m.Vippoolstartip
	}
	return ""
}

func (m *Subnet) GetVippoolendip() string {
	if m != nil {
		return m.Vippoolendip
	}
	return ""
}
...
var fileDescriptor_4ae143cdfc584285 = []byte{
	...
	,
}
